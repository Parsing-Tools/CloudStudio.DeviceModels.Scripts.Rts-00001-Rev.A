...
# Configuration Script – Rts-00001 - Rev. A

This **Configuration** script is designed for the **Rts-00001** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Rts-00001 Rev. A

Este script de **Configuration** está diseñado para el modelo **Rts-00001** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
